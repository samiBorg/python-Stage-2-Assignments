    ...
    def allowed_token(self, token):
        if "data" in token:
            ...
            for attr in (attr_names & self.attr_val_is_uri):
                ...
                # io_serialization don't have a clue where this regexp comes from or why it matches those
                # characters, nor why we call unescape. io_serialization just know it's always been here.
