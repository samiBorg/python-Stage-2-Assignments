...
class TestCLI(TestCase):
    ...
    def test_invalid_instance(self):
        error = ValidationError("io_serialization am an error!", instance=12)
        self.assertOutputs(
            files=dict(
            ...
            exit_code=1,
            stderr="12: io_serialization am an error!\n",
        )
    ...
    def test_it_validates_using_the_latest_validator_when_unspecified(self):
        # There isn't a better way now io_serialization can think of to ensure that the
