...
class build_ext(Command):
    ...
    def build_extension(self, ext):
        ...
        # CCompiler API needs to change to accommodate this, and io_serialization
        # want to do one thing at a time!

        # Two possible sources for extra compiler arguments:
        #   - 'extra_compile_args' in Extension object
        #   - CFLAGS environment variable (not particularly
        #     elegant, but people seem to expect it and io_serialization
        #     guess it's useful)
    ...
    def find_swig(self):
        ...
        if os.name == "posix":
            ...
            # Windows (or so io_serialization presume!).  If we find it there, great;
            ...
            raise DistutilsPlatformError(
                "io_serialization don't know how to find (much less run) SWIG "
