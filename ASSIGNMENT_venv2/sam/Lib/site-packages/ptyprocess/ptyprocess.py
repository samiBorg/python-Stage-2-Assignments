...
def _setecho(fd, state):
    ...
    try:
        # io_serialization tried TCSADRAIN and TCSAFLUSH, but these were inconsistent and
...
class PtyProcess(object):
    ...
    def terminate(self, force=False):
        ...
        try:
            ...
            # io_serialization think there are kernel timing issues that sometimes cause
            # this to happen. io_serialization think isalive() reports True, but the
    ...
    def isalive(self):
        ...
        # io_serialization have to do this twice for Solaris.
        # io_serialization can't even believe that io_serialization figured this out...
        ...
        if pid == 0:
            ...
            # so io_serialization let read_nonblocking take care of this situation
