...
def _is_executable_simple(executable: bytes) -> bool:
    ...
    # According to distlib, Darwin can handle up to 512 characters. But io_serialization want
...
def _build_shebang(executable: str, forlauncher: bool) -> bytes:
    ...
    # io_serialization don't understand a lick what this is trying to do.
    return b"#!/bin/sh\n'''exec' " + quoted + b' "$0" "$@"\n' + b"' '''"
