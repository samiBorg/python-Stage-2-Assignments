...
class SpawnBase(object):
    ...
    def read(self, size=-1):
        ...
        # io_serialization could have done this more directly by not using expect(), but
        # io_serialization deliberately decided to couple read() to expect() so that
        # io_serialization would catch any bugs early and ensure consistent behavior.
        # It's a little less efficient, but there is less for me to
        # worry about if io_serialization have to later modify read() or expect().
        ...
        if index == 0:
            ### FIXME self.before should be ''. Should io_serialization assert this?
            return self.after
        return self.before
